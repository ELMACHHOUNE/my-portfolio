...
import { Facebook, Github, Twitter, YouTube, Instagram, Linkedin } from "../components/AllSvgs";
    ...
    <Icons>
      ...
      >
        <a
          style={{ color: "inherit" }}
          target="_blank"
          href={"https://youtube.com/ELMACHHOUNE"}
        >
          <YouTube
            width={25}
            height={25}
      ...
      >
        <a
          style={{ color: "inherit" }}
          target="_blank"
          href={"https://www.instagram.com/mohamed.elmachhoune/"}
        >
          <Instagram
            width={25}
            height={25}
